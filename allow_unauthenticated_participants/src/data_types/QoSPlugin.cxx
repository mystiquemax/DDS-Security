...
namespace Not_Secret {
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        try {
            ...
            if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                serializedSampleMaxSize = ::Not_Secret::Not_SecretPlugin_get_serialized_sample_max_size(
                    epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
                ...
                if (PRESTypePluginDefaultEndpointData_createWriterPool(
                    ...
                    endpoint_info,
                    (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                    ::Not_Secret::Not_SecretPlugin_get_serialized_sample_max_size, epd,
                    (PRESTypePluginGetSerializedSampleSizeFunction)
                    PRESTypePlugin_interpretedGetSerializedSampleSize,
                    epd) == RTI_FALSE) {
                    PRESTypePluginDefaultEndpointData_delete(epd);
    ...
    Not_SecretPlugin_copy_sample(
        ...
        const Not_Secret *src)
    {
        return ::Not_Secret::Not_SecretPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        ::Not_Secret::Not_SecretPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        ::Not_Secret::Not_SecretPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        ::Not_Secret::Not_SecretPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        ::Not_Secret::Not_SecretPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        ::Not_Secret::Not_SecretPlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        ::Not_Secret::Not_SecretPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        PRESTypePlugin_interpretedGetSerializedSampleMinSize;
        plugin->getDeserializedSampleMaxSizeFnc = NULL; 
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        ::Not_Secret::Not_SecretPlugin_get_key_kind;
        ...
        */
        ...
        #else
        plugin->typeCode = (struct RTICdrTypeCode *) 
        &::rti::topic::dynamic_type< ::Not_Secret::Not_Secret >::get().native();
        #endif
        plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
        ...
        static const char * TYPE_NAME = "Not_Secret::Not_Secret";
        plugin->endpointTypeName = TYPE_NAME;
        plugin->isMetpType = RTI_FALSE;
        return plugin;
    }
