...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< ::Not_Secret::Not_Secret > {
            static DDS_TypeCode * get()
            {
                using namespace ::rti::topic::interpreter;
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"Not_Secret::Not_Secret", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                {
                    size_t candidateTypeSize = sizeof(::Not_Secret::Not_Secret);
                ...
                interpreter::get_aggregation_value_pointer< ::Not_Secret::Not_Secret >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< ::Not_Secret::Not_Secret >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< ::Not_Secret::Not_Secret >::get())));
        }
    }
}
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::Not_Secret::Not_Secret >:: register_type(
            ::dds::domain::DomainParticipant& participant,
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                ::Not_Secret::Not_SecretPlugin_new,
                ::Not_Secret::Not_SecretPlugin_delete);
        }

        std::vector<char>& topic_type_support< ::Not_Secret::Not_Secret >::to_cdr_buffer(
            std::vector<char>& buffer, 
        ...
        void topic_type_support< ::Not_Secret::Not_Secret >::from_cdr_buffer(::Not_Secret::Not_Secret& sample, 
        const std::vector<char>& buffer)
        {
            ...
            RTIBool ok  = Not_SecretPlugin_deserialize_from_cdr_buffer(
                ...
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create ::Not_Secret::Not_Secret from cdr buffer");
        }

        void topic_type_support< ::Not_Secret::Not_Secret >::reset_sample(::Not_Secret::Not_Secret& sample) 
        {
            sample.Data(0);
        }

        void topic_type_support< ::Not_Secret::Not_Secret >::allocate_sample(::Not_Secret::Not_Secret& sample, int, int) 
        {
            RTIOsapiUtility_unusedParameter(sample);
        }
    }
