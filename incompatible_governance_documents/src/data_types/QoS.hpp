...
#ifndef QoS_2129333519_hpp
#define QoS_2129333519_hpp
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::Smth::Not_Secret > {
            NDDSUSERDllExport static std::string value() {
                return "Smth::Not_Secret";
            }
        };

        template<>
        struct is_topic_type< ::Smth::Not_Secret > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::Smth::Not_Secret > {
            NDDSUSERDllExport 
            static void register_type(
                ::dds::domain::DomainParticipant& participant,
                const std::string & type_name);
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::Smth::Not_Secret& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::Smth::Not_Secret& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::Smth::Not_Secret& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::Smth::Not_Secret > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::Smth::Not_Secret > {
            static const ::dds::core::xtypes::ExtensibilityKind::type kind =
            ::dds::core::xtypes::ExtensibilityKind::EXTENSIBLE;    };
